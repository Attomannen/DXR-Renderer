...
namespace Ag
{
	...
	//
	//   profiler.BeginFrame();
	//   { AG_GPU_SCOPE(profiler, "Geometry");  ...draw... }
	//   { AG_GPU_SCOPE(profiler, "Lighting");  ...draw... }
	//   profiler.EndFrame();
...
#define AG_GPU_SCOPE_CAT2(a, b) a##b
#define AG_GPU_SCOPE_CAT(a, b) AG_GPU_SCOPE_CAT2(a, b)
#define AG_GPU_SCOPE(profiler, name) Ag::GpuScope AG_GPU_SCOPE_CAT(_gpuScope_, __LINE__)((profiler), (name))
...
#define AG_PROFILE_SCOPE(gpuProfiler, name) Ag::ProfileScope AG_GPU_SCOPE_CAT(_profileScope_, __LINE__)((gpuProfiler), (name))
