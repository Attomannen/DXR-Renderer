...
using namespace Ag;
GraphicsEngine* Ag::GraphicsEngine::ourInstance = nullptr;
...
void Ag::GraphicsEngine::Shutdown()
{
...
{
	AG_CPU_SCOPE("GraphicsEngine::Init");
...
void Ag::GraphicsEngine::SetFullScreen(bool aFullScreen)
{
