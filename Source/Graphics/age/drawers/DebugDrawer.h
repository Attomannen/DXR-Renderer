...
#ifndef _RETAIL
#define DEBUG_DRAW_LINE(aFrom, aTo, aColor) Ag::DebugDrawer::DrawLine(aFrom, aTo, aColor);
#define DEBUG_DRAW_LINES(aFrom, aTo, aColor, aCount) Ag::DebugDrawer::DrawLines(aFrom, aTo, aColor, aCount);
#define DEBUG_DRAW_ARROW(aFrom, aTo, aColor, aArrowHeadSize) Ag::DebugDrawer::DrawArrow(aFrom, aTo, aColor, aArrowHeadSize);
#define DEBUG_DRAW_CIRCLE(aFrom, aRadius, aColor) Ag::DebugDrawer::DrawCircle(aFrom, aRadius, aColor);
#else
