...
void PerformanceGraph::Init(Ag::Color& aBackgroundColor, Ag::Color& aLineColor, const std::string& aText)
{
	...
	myText = std::make_unique<Ag::Text>("Text/arial.ttf");
	myText->SetText("--");
...
void PerformanceGraph::Render()
{
	...
	Ag::GraphicsEngine::GetInstance()->GetCustomShapeDrawer().Draw(*myBackground);
	...
	{	
		...
		Ag::GraphicsEngine::GetInstance()->GetLineDrawer().Draw(lines);
