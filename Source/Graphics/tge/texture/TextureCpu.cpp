...
namespace
{
	...
	Tga::TextureCpu::Image ToImage(const ScratchImage& scratch)
	{
		Tga::TextureCpu::Image img;
...
Tga::TextureCpu::Image Tga::TextureCpu::Load(const std::string& aPath)
{
...
Tga::TextureCpu::Image Tga::TextureCpu::Resize(const Image& src, int w, int h)
{
	Image out;
...
bool Tga::TextureCpu::SaveCookedDds(const std::string& aPath, const Image& img, Kind kind)
{
