...
public:
	...
	ScriptNodeId CreateNode(ScriptNodeTypeId typeId, std::unique_ptr<ScriptNodeBase>&& node, Ag::Vector2f pos);
	...
	/// </summary>
	void CreateNodeWithReusedId(ScriptNodeId id, ScriptNodeTypeId typeId, std::unique_ptr<ScriptNodeBase>&& node, Ag::Vector2f pos);
	/// <summary>
	...
	Ag::Vector2f GetPosition(ScriptNodeId id) const;
	...
	void SetPosition(ScriptNodeId id, Ag::Vector2f pos);
