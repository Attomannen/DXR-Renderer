...
public:
	...
	Property ReadPin(Ag::ScriptExecutionContext& ctx, Ag::ScriptPinId) const override
	{
...
public:
	...
	Ag::Property ReadPin(Ag::ScriptExecutionContext& ctx, Ag::ScriptPinId) const override
	{
		T x = *ctx.ReadInputPin(myXPinId).Get<T>();
		T y = *ctx.ReadInputPin(myYPinId).Get<T>();
...
public:
	...
	Property ReadPin(Ag::ScriptExecutionContext& ctx, Ag::ScriptPinId pin) const override
	{
...
void Ag::RegisterCommonMathNodes()
{
