...
#include "age/rhi/dx11/Dx11Pools.h"
...
namespace Ag::rhi::dx11
{
	...
	// The DX11 backend. In Stage 1 it wraps the already-created Ag::DX11 statics
	...
	private:
		...
		ID3D11Device*        myDevice = nullptr;   // borrowed from Ag::DX11
