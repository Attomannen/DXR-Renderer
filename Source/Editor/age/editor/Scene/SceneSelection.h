...
namespace Ag
{
	...
	public:
		...
		bool IsActive();
		void Update(const Vector2f& aMousePos, const Vector2f& aViewportPos, const Vector2f aViewportSize, const Ag::Camera& aCamera);
		bool CheckFrustum(const Ag::BoxSphereBounds& someBounds);
