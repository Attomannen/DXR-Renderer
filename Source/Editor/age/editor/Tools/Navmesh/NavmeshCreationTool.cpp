...
struct Lines {
	std::vector<Ag::Color> colors;
	std::vector<Ag::Vector3f> from;
	std::vector<Ag::Vector3f> to;
...
void NavmeshCreationTool::DrawNavmesh() const
{
	...
	Ag::Application& engine = *Ag::Application::GetInstance();
	Ag::LineDrawer& drawer = GraphicsEngine::GetInstance()->GetLineDrawer();
	...
	for (size_t i = 0; i < batches; ++i)
	{
		...
		Ag::LineMultiPrimitive primitives { 
			.colors = colors.data(), 
