...
namespace Ag
{
	...
	Ag::StringId operator""_tgaid(const char*, std::size_t);
...
using Ag::operator""_tgaid;

template<>
struct std::hash<Ag::StringId>
{
	std::size_t operator()(Ag::StringId const& id) const noexcept
	{
