...
void Ag::PropertyEditor::HelpMarker(const char* aDescription, bool aSameLine)
{
	if (aSameLine)
		ImGui::SameLine();
...
bool Ag::PropertyEditor::PropertyHeader(const char* aHeaderName)
{
...
bool Ag::PropertyEditor::BeginPropertyTable()
{
...
void Ag::PropertyEditor::EndPropertyTable()
{
	ImGui::EndTable();
}

void Ag::PropertyEditor::PropertyLabel(bool aHideSeparator)
{
...
void Ag::PropertyEditor::PropertyValue(bool aHideSeparator)
{
...
namespace
{
	Ag::PropertyEditor::AssetListFunction locAssetListFunction = nullptr;
...
void Ag::PropertyEditor::RegisterAssetListFunction(AssetListFunction function)
{
	locAssetListFunction = function;
}

bool Ag::PropertyEditor::AssetField(const char* id, StringId& value, std::initializer_list<const char*> extensions, const char* emptyLabel)
{
