...
#include <age/debugging/StackTrace.h>
#include <algorithm>
#include <array>
#include <mutex>
...
void Ag::StartMemoryTracking(const MemoryTrackingSettings& trackingSettings)
{
...
void Ag::StopMemoryTrackingAndPrint()
{
	std::lock_guard<std::mutex> guard(locAllocationMapMutex);
	...
	else
	{
		...
		else
		{
			...
			OutputDebugStringA("== when calling Ag::Application::GetInstance()->Start(...)\n");
			OutputDebugStringA("================================================================================\n");
		}
	}
...
void Ag::StartMemoryTracking(const MemoryTrackingSettings&) {}
void Ag::StopMemoryTrackingAndPrint() {}
