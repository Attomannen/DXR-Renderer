...
unsigned int Ag::Log::GetErrorsReported()
{
	if (ourInstance)
	{
...
float Ag::Log::RegisterLog(std::string_view aMessage, LogType aType, unsigned int& outCount)
{
...
void Ag::Log::SetConsoleColor(int aColor)
{
	HANDLE  hConsole;
...
void Ag::Log::LogWrite(LogType aType, const char* aFile, int aLine, const char* aFormat, va_list aList)
{
	char buffer[4096];
...
void Ag::Log::LogError(const char* aFile, int aLine, const char* aFormat, ...)
{
	va_list argptr;
...
void Ag::Log::LogInfo(const char* aFormat, ...)
	{
	va_list argptr;
	va_start(argptr, aFormat);
...
void Ag::Log::LogTip(const char* aFormat, ...)
{
	va_list argptr;
	va_start(argptr, aFormat);
...
void Ag::Log::LogMessage(LogType aType, const char* aFormat, ...)
{
	va_list argptr;
	va_start(argptr, aFormat);
...
void Ag::Log::LogMessage(LogType aType, const char* aFile, int aLine, const char* aFormat, ...)
{
	va_list argptr;
	va_start(argptr, aFormat);
...
size_t Ag::Log::GetLatestLogEntries(const LogEntry** aOutBuffer, size_t aMaxCount)
{
