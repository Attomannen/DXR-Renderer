...
AnimationClip* Ag::GetAnimationClip(StringId path)
{
	if (path.IsEmpty())
		return nullptr;
	...
	filePath << Ag::Settings::GameAssetRoot() << "/" << path.GetString();
...
AnimationClip* Ag::GetOrCreateAnimationClip(StringId path)
{
...
void Ag::SaveAnimationClip(StringId path)
{
