...
void Ag::RegisterGetSkeletonFunction(std::shared_ptr<const Skeleton>(*aGetFunction)(std::string_view))
{
	locGetSkeletonFunction = aGetFunction;
}

std::shared_ptr<const Skeleton> Ag::GetSkeleton(std::string_view someFilePath)
{
