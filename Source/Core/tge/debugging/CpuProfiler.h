...
//
//   Tga::CpuProfiler::Get().BeginFrame();
//   { TGA_CPU_SCOPE("Update"); ... }
//   Tga::CpuProfiler::Get().EndFrame();
//
...
#define TGA_CPU_SCOPE_CAT2(a, b) a##b
#define TGA_CPU_SCOPE_CAT(a, b) TGA_CPU_SCOPE_CAT2(a, b)
#define TGA_CPU_SCOPE(name) Tga::CpuScope TGA_CPU_SCOPE_CAT(_cpuScope_, __LINE__)(name)
