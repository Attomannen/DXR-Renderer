...
void main(uint3 id : SV_DispatchThreadID)
{
	...
	// A third, finer octave so the erosion texture itself carries more than
	// two frequencies of structure -- otherwise every erosion sample looks
	// like a scaled copy of the same two blobs instead of real grain.
	float w2 = CloudsWorley3D(p * 2.5f + 23.7f, kPeriod * 2.5f);
